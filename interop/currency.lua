...
--function smartshop.currency.can_exchange_currency(player_inv, shop_inv, send_inv, refill_inv, pay_stack, give_stack, is_unlimited)
--    --[[
...
--    ]]--
--    local pay_amount = smartshop.sum_currency_stack(pay_stack)
...
--				return false, ("%s %s is sold out"):format(give_stack:get_name(), give_stack:get_count())
--            end
--			local leftover
...
--end
--
--function smartshop.currency.exchange_currency(player_inv, shop_inv, send_inv, refill_inv, items_to_take, item_to_give, pay_stack, give_stack, is_unlimited)
